...
import static ru.netology.lists.ListViewActivity.KEY1;
import static ru.netology.lists.ListViewActivity.KEY2;

public class Adapter extends BaseAdapter implements ListAdapter {
    private List<Map<String, String>> mValues;
    private Context mContext;

    public Adapter(List<Map<String, String>> values, Context applicationContext) {
        mValues = values;
